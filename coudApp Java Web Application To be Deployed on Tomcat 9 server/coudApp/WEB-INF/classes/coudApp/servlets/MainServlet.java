...
import coudApp.pojos.*;
import coudApp.Logic.*;
import java.util.Random;
import java.util.Date;
import java.text.DateFormat;
import java.text.SimpleDateFormat;
import coudApp.DataHandling.*;
...
final public class MainServlet extends HttpServlet
{
	...
	private static void startDBConnection()
	{
		...
		final String DB_URL = "jdbc:mysql://localhost:3306/coudApp";

		//Database credentials
		final String USER = "palashsarkar";
	    final String PASS = "****";
